// Package users_permissions SQL constants.
//
// PLA-0048 / RF1.2.5. Every SQL string literal used by the users_permissions
...
//
// All reads target the mmff_vector pool — users_permissions is single-DB and
