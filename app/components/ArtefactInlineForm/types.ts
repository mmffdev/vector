...
// PARENT_PREFIX_MAP retired — the allowed-parent rule now lives on each work
// type as `execution_parent_slots` (backfilled from this map by migration 181)
// and is resolved at runtime via buildReparentMap / resolveAllowedTypes. See
// docs/c_tech_debt.md TD-PARENT-CANDIDATES-DYNAMIC (paid for work scope).
