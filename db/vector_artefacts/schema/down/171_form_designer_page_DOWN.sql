-- ============================================================
-- 171_form_designer_page_DOWN.sql
--
-- Reverse of 171_form_designer_page.sql. Deletes inner-most first so
...
DELETE FROM users_nav_pinned
 WHERE users_nav_pinned_item_key = 'ws-form-designer';

-- ── 2. Remove role grants for the system 'ws-form-designer' page. ─
DELETE FROM users_roles_pages
 WHERE users_roles_pages_id_page IN (
    SELECT pages_id FROM pages
     WHERE pages_key_enum        = 'ws-form-designer'
