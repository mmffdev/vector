...
These can be customised per project. The combination of abbreviation, project key, and sequential number creates a globally unique, human‑readable reference for every work item in the system.
